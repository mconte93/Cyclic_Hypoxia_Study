% The code allows to simulate the full model in the early stage tumor, based on the interaction 
...
while T<Tmax
   ...
   if mod(step,1000)==0
   save('EarlyStage_partial.mat')
   end
   
end 

%Saving option for final results
save('EarlyStage_final.mat')
