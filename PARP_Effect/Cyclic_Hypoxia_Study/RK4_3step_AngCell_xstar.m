function [K] = RK4_3step_AngCell_xstar(par,X,Tie2,Ang1,Ang2,z1,z2,Ang2Tie2_2,Ang1Tie2_4)
...
%angiopoietin module: pTie2, R
   ...
   [Fun,ftilde]=pTie2_interpolation_adim(z1,z2,Tie2,dos,Ang1_0,Ang2_0);
   
   %Evaluation of F(R)
   F=g2*R*(k_R*(1-R/K_R)-m/(R+b))-d_R*R;

   %Vectorial fields  
   V1=alfa1*gamma1*Ang1*(Tie2)^4-delta1*gamma1*Ang1Tie2_4;
   V2=alfa2*gamma2*Ang2*(Tie2)^2-alfam2*delta2*gamma2*Ang2Tie2_2;
   dTie2dt=-V1-V2;
   
   b_pTie2=gamma3*dTie2dt*(R-F*Fun*ftilde);
   b_R=-F*Fun*(Tie2_0*ftilde/Tie2)*dTie2dt;
